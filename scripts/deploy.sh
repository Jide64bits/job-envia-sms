...
SECRETS="ENV=ENV:latest,DB_HOST=DB_HOST:latest,DB_USER=DB_USER:latest,DB_PASSWORD=DB_PASSWORD:latest,DB_NAME=DB_NAME:latest,DB_PORT=DB_PORT:latest,EVOLUTION_BASE_URL=EVOLUTION_BASE_URL:latest,EVOLUTION_INSTANCE=EVOLUTION_INSTANCE:latest,EVOLUTION_API_KEY=EVOLUTION_API_KEY:latest"
